    ...
    echo "--";
     ...
     echo "</br>";
      ...
      //  continue;
        ...
        // }
        try {
         $stmt = $conn1->prepare("UPDATE account SET tongnap = tongnap + :price*$giatri, tongnap2 = tongnap2 + :price* $giatri, tongnap3 = tongnap3 + :price, vnd = vnd + :price1 WHERE id = :username");
    ...
    echo "Error: " . $e->getMessage();
         ...
         $update_query1 = "INSERT INTO mbbank (tranId, io, amount, comment)
                         VALUES (:tranId, :io, :amount, :user_id)";
                                                $stmt = $conn1->prepare($update_query1);
                                                $stmt->bindParam(':tranId', $tranId);
