...
<div class="page-layout-body" style="margin-top: 16px;">
    <div class="col">
        <div class="ant-row">
			<div class="dragonball-title">
				Giới thiệu Nro Ngọc rồng Đấu Phá
			</div>
		</div>
