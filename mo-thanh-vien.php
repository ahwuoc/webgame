    ...
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            ...
            if (isset($_POST['submit'])) {
                ...
                } elseif (($_status == '0' || $_status == '-1') && $_coin < 0) {
            ...
            <form id="form" method="POST">
                <div> Thông tin mở thành viên:<br>- Mở thành viên Free<strong> 50.000 VNĐ</strong>. <img
                    ...
                    dựng, ủng hộ ngocrongdaupha.vn hoạt động.<br>
                ...
                <?php if ($_status == '0' || $_status == '-1'): ?>
                    ...
                    <?php else: ?>
                        <div class="text-danger pb-2 font-weight-bold">Bạn không đủ 50.000 VND để mở thành viên!</div>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if ($_status == 1): ?>
                    <div class="text-danger pb-2 font-weight-bold">Bạn đã mở thành viên rồi! Hãy nhập code : codethanhvien1 - codethanhvien2 - codethanhvien3</div>
                <?php endif; ?>
            </form>
                                                    </div>
