...
<head>
    ...
    <meta name="description" content="Website chính thức của Ngọc rồng Đấu Phá – Game Bay Vien Ngoc Rong Mobile nhập vai trực tuyến trên máy tính và điện thoại về Game 7 Viên Ngọc Rồng hấp dẫn nhất hiện nay!">
    ...
    ?>
                    ...
                    <div class="marquee-container">
						<div class="marquee-wrapper">
							<div class="marquee-text">Chào Mừng Cư Dân Đến Với Ngọc rồng Đấu Phá. Hãy Tải Game Và Chiến Ngay Nào.</div>
						</div>
					</div>
                    <div class="ant-col ant-col-xs-24 ant-col-sm-24 ant-col-md-24">
                        <div class="ant-row ant-row-space-around ant-row-middle header-menu">
