...
define('LOGO_PATH', '/image/logo.png'); // Đường dẫn logo chính
define('LOGO_ALT', 'Ngọc rồng Đấu Phá Logo'); // Alt text cho logo
define('FAVICON_PATH', '/image/logo.png'); // Đường dẫn favicon
define('LOGO_MAX_WIDTH', '300px'); // Chiều rộng tối đa của logo
define('LOGO_MAX_HEIGHT', '150px'); // Chiều cao tối đa của logo
$_Title = 'Ngọc rồng Đấu Phá | Máy Chủ Ngọc Rồng Online';
$_ServerName = 'Ngọc rồng Đấu Phá';
$_Description = 'Website chính thức của Ngọc rồng Đấu Phá – Game Bay Vien Ngoc Rong Mobile nhập vai trực tuyến trên máy tính và điện thoại về Game 7 Viên Ngọc Rồng hấp dẫn nhất hiện nay!';
...
#---------------#
#Downloads
$_Windows = 'https://drive.google.com/file/d/1NHEbHa_-5JnF5Dc4HheZGZCw_0R5uvgx/view?usp=sharing'; // Downloads nơi lưu file game (Windows)
$_Iphone = 'https://testflight.apple.com/join/Se9bGBhR';
$_Java = '/Downloads/ThangHoa.jar';
$_Android = 'https://drive.google.com/file/d/1RxN9cwOSDU7R-2te7PLl_gMzehDNMgFv/view?usp=sharing'; // Downloads nơi lưu file game (Android)
