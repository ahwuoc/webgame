                    ...
                    <tr>
                        ...
                        <td class="posts_boxContent__XjPnA">
                            <div class="posts_contentPost___PyGu">
                                <div class="posts_title__P1NsS">🔥 Hướng Dẫn Up Set Kích Hoạt 🔥</div>
                            <div class="posts_boxTime__bFU28"><span class="posts_time__PFYQE"><i>18:18 21/02/2025</i></span></div>
                            <div>
                            <div class="fr-view" style="background-color: rgb(255, 255, 255);">
                                <p><strong>📅 Thời Gian Diễn Ra:</strong></p>
                                <p>- Các <strong>giờ</strong> trong ngày.</p>
        
                                <p><strong>📌 Nội Dung Sự Kiện:</strong></p>
                                <p>- Người chơi có thể <strong>up Set Kích Hoạt</strong> tại <strong>3 map đầu</strong> của <strong>3 hành tinh</strong>.</p>
								<p><strong>- Tỉ Lệ:</strong> Thấp.</p>

                            <hr>

                                <p><strong>🔥 Xayda - 4 Loại Set Kích Hoạt:</strong></p>
                            <ul>
                                <li>Set Nappa</li>
                                <li>Set Kakarot</li>
                                <li>Set Cadic</li>
                                ...
                                <p><strong>🌎 Trái Đất - 4 Loại Set Kích Hoạt:</strong></p>
                            <ul>
                                <li>Set Songoku</li>
                                <li>Set Kirin</li>
                                <li>Set Thiên Xi Hăng</li>
                                <li>Set Thần Vũ Trụ Kaio</li>
                            </ul>

                                <p><strong>🌿 Namec - 5 Loại Set Kích Hoạt:</strong></p>
                            <ul>
                                <li>Set Piccolo</li>
                                <li>Set Ốc Tiêu</li>
                                <li>Set Pikkoro Daimao</li>
                                <li>Set Nail - Chiến Binh Namec</li>
								<li>Set Liên Hoàn</li>
                            </ul>

                            <hr>

                                <p><strong>📍 Cách Nhận Set Kích Hoạt Thường:</strong></p>
                                <p>📌 <strong>Tỷ lệ rơi đồ tại các map:</strong></p>
                            <ul>
                                <li>Đồi Hoa Cúc</li>
                                <li>Thung Lũng Tre</li>
                                <li>Rừng Nấm</li>
                                <li>Đồi Nấm Tím</li>
                                <li>Thị Trấn Moori</li>
                                <li>Thung Lũng Maima</li>
                                <li>Đồi Hoang</li>
                                <li>Làng Plant</li>
                                <li>Rừng Nguyên Sinh</li>
                            </ul>

                            <hr>

                                <p><strong>⚡ Set Kích Hoạt VIP (Thần Linh):</strong></p>
                                <p>- Người chơi săn đủ <strong>Đồ Thần</strong> và mang đến <strong>NPC Bà Hạt Mít</strong> để tiến hành <strong>nâng cấp trang bị</strong>.</p>
                                <p>- NPC sẽ hướng dẫn chi tiết cách nâng cấp.</p>

                                <p><strong>[ NGOC RONG HUYETCHIEN ]</strong></p>
                            </div>
                            </div>
                            </div>
                        </td>
...
<!-- <script src="https://nroBlue.me/public/dist/js/bootstrap.min.js"></script> -->
<script>
