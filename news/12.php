...
<?php include_once '../core/head.php'; ?>
                    ...
                    <tr>
                        ...
                        <td class="posts_boxContent__XjPnA">
                            <div class="posts_contentPost___PyGu">
                                <div class="posts_title__P1NsS">💎 Hệ Thống Vàng & Ngọc - Ngọc Rồng <?php echo GAME_NAME; ?> 💎</div>
    ...
    <div class="fr-view" style="background-color: rgb(255, 255, 255);">
        ...
        <p>Trong Ngọc Rồng <?php echo GAME_NAME; ?>, người chơi có thể thu thập các nguyên liệu quý hiếm để phát triển nhân vật và nâng cấp trang bị. Hôm nay, chúng ta sẽ tìm hiểu về ba tài nguyên quan trọng: <strong>Ngọc Xanh, Hồng Ngọc và Vàng</strong>.</p>

        <hr>

        <p><strong>🔹 Ngọc Xanh - Chứng Minh Sức Mạnh!</strong></p>
        <ul>
            <li><strong>Cách sở hữu:</strong> Đánh bại Tiểu Đội Trái Đất gồm 6 Boss mạnh mẽ:</li>
            <ul>
                <li>⚔️ <strong>Số 1</strong></li>
                <li>⚔️ <strong>Số 2</strong></li>
                <li>⚔️ <strong>Số 3</strong></li>
                <li>⚔️ <strong>Số 4</strong></li>
                <li>⚔️ <strong>Tiểu Đội St</strong></li>
                <li>⚔️ <strong>Mở 1 Túi Ruby + gem Ramdom 1-100k Ngọc/Túi</strong></li>
            </ul>
            <li><strong>Đặc biệt:</strong> Ngọc Xanh <strong>không thể mua</strong> và <strong>không có miễn phí</strong>, chỉ có thể săn Boss để nhận!</li>
        </ul>

        <hr>

        <p><strong>🔴 Hồng Ngọc - Kho Báu Của Các Chiến Binh!</strong></p>
        <ul>
            <li><strong>Cách sở hữu:</strong> Hồng Ngọc có thể thu thập khi train quái tại <strong>tất cả bản đồ</strong> trong game.</li>
            <li><strong>Đặc biệt:</strong> Giống như Ngọc Xanh, Hồng Ngọc <strong>không thể mua</strong> và <strong>không có miễn phí</strong>, chỉ có thể tự săn!</li>
        </ul>

        <hr>

        <p><strong>💰 Vàng - Đồng Tiền Quan Trọng!</strong></p>
        <ul>
            <li><strong>Cách sở hữu:</strong> Người chơi có thể kiếm vàng từ nhiều hoạt động khác nhau:</li>
            <ul>
                <li>💥 Train quái tại các bản đồ trong game.</li>
                <li>🔥 Hoàn thành <strong>Nhiệm Vụ Bò Mộng</strong>.</li>
                <li>🎊 Tham gia sự kiện <strong>Nấu Bánh Ngày Tết</strong>.</li>
                <li>🗝️ Mở <strong>Rương 12</strong> để nhận phần thưởng.</li>
                <li>⚡ Chinh phục <strong>Phó Bản Khí Gas</strong>.</li>
                <li>🏴‍☠️ Khám phá <strong>Bản Đồ Kho Báu</strong>.</li>
                <li>🏆 Chiến đấu trong <strong>Tranh Bá Ngọc Rồng</strong>.</li>
                <li>💪 Hoàn thành <strong>Mốc Sức Mạnh</strong> và <strong>Mốc Nhiệm Vụ</strong>.</li>
                <li>🏅 Tham gia giải đấu <strong>Giải Siêu Hạng</strong>.</li>
                <li>🕵️‍♂️ Săn Boss <strong>Ăn Trộm</strong> để nhận vàng.</li>
                <li>✨ Ngoài ra, còn có thể nhận thông qua:</li>
                <ul>
                    <li>🌟 <strong>Nội Tại Vàng</strong> – Gia tăng lợi ích khi sử dụng.</li>
                    <li>🍀 <strong>Cỏ 4 Lá</strong> – Tiền Tệ Mua All Đồ.</li>
                    <li>💎 <strong>Set Sao Pha Lê Vàng</strong> – Trang bị đặc biệt giúp kiếm vàng hiệu quả.</li>
                </ul>
            </ul>
        </ul>
