                    ...
                    <tr>
                        ...
                        <td class="posts_boxContent__XjPnA">
                            <div class="posts_contentPost___PyGu">
                                <div class="posts_title__P1NsS">🔥 CƠ CHẾ TỔNG HỢP - NGỌC RỒNG <?php echo GAME_NAME; ?> 🔥</div>
...
<div>
    <div class="fr-view" style="background-color: rgb(255, 255, 255);">
        <p><strong>🌟 Hệ Thống Boss Broly & Super Broly</strong></p>
        <ul>
            <li>🔎 <strong>Tìm Kiếm Boss Broly:</strong> Xuất hiện ngẫu nhiên tại <strong>3 hành tinh</strong>.</li>
            <li>🛡️ Yêu cầu: Phải mặc <strong>Set Phản Sát Thương</strong> và có trên <strong>1.5 triệu HP</strong> để kích hoạt.</li>
            <li>💀 Khi tiêu diệt Broly, có tỉ lệ <strong>ramdom xuất hiện Boss Super Broly</strong>.</li>
            <li>🔥 Super Broly sẽ dẫn theo một <strong>đệ tử có sức mạnh 1.5 triệu</strong>.</li>
            <li>⚡ Các loại đệ tử và chỉ số cộng thêm:</li>
            <ul>
                <li>👤 <strong>Thường</strong>: +0% chỉ số.</li>          
                <li>🐱 <strong>Broly</strong>: +1500% chỉ số.</li>
                <li>🟢 <strong>black rose</strong>: +2000% chỉ số.</li>
                <li>🖤 <strong>Black goku</strong>: +1800% chỉ số.</li>
            </ul>
        </ul>

        <hr>

        <p><strong>💎 Hệ Thống Ghép Đồ Thần</strong></p>
        <ul>
            <li>⚔️ <strong>Mảnh Thần</strong>, <strong>Đá Ghép Thần</strong> & <strong>Công Thức Thần</strong> có thể nhận được khi săn Boss.</li>
            <li>❌ <strong>Server không rơi đồ thần trực tiếp</strong>, chỉ có thể ghép!</li>
            <li>🎁 Boss rơi ngẫu nhiên các vật phẩm:</li>
            <ul>
                <li>👕 Mảnh áo, quần, giày, găng, rada.</li>
                <li>💎 Đá Ghép Thần.</li>
                <li>📜 Công Thức Thần.</li>
            </ul>
            <li>🛠️ Khi thu thập đủ <strong>x99 mảnh của 1 loại</strong>, <strong>x1 Đá Ghép Thần</strong> và <strong>x1 Công Thức Thần</strong>, đến <strong>NPC Bà Hạt Mít</strong> để ghép.</li>
            <li>🎲 Ghép thành công sẽ <strong>ramdom đồ thần</strong> theo hành tinh tương ứng với loại mảnh.</li>
        </ul>

        <hr>

        <p><strong>❄️ Hệ Thống Treo Quái Tại Cold & Đổi Đồ Hủy Diệt</strong></p>
        <ul>
            <li>📌 Khi mặc <strong>Full Set Thần</strong>, có thể treo quái tại <strong>Cold</strong>.</li>
            <li>🎲 Tại đây có <strong>tỉ lệ rơi đồ thần</strong>, nhưng tỉ lệ thấp.</li>
            <li>🍖 Khi kiếm đủ <strong>x99 Thức Ăn</strong>, đến <strong>Hành Tinh Kaio</strong> tìm <strong>Thần Bill</strong> để đổi <strong>Đồ Hủy Diệt</strong>.</li>
        </ul>

        <hr>

        <p><strong>🌟 Hệ Thống Đồ Max 8 & Tinh Ấn - Tinh Thạch</strong></p>
        <ul>
            <li>⚙️ <strong>Đồ có thể nâng cấp tối đa 8 sao</strong>.</li>
            <li>🔧 Sao thứ 8 yêu cầu các vật phẩm đặc biệt:</li>
            <ul>
                <li>🔨 <strong>Dùi Đục Sao Pha Lê Cấp 2</strong>.</li>
                <li>✨ <strong>Đánh Bóng Lỗ</strong>.</li>
                <li>🪨 <strong>Đá Hametit</strong>.</li>
            </ul>
            <li>💠 <strong>Tinh Ấn</strong>: Tăng <strong>5000% SD chỉ số</strong> theo Set Tinh Ấn.</li>
            <li>🌀 <strong>Tinh Thạch</strong>: Cường hóa chỉ số cho <strong>Pet</strong>.</li>
            <li>🛡️ <strong>Nâng cấp Giáp Luyện Tập</strong> giúp mở thêm chỉ số đặc biệt.</li>
        </ul>

        <hr>

        <p><strong>🔴 Lưu Ý:</strong> Cơ chế này giúp người chơi <strong>cày cuốc</strong> để sở hữu các trang bị mạnh nhất, tạo nên sự cạnh tranh và thử thách hấp dẫn trong Ngọc Rồng <?php echo GAME_NAME; ?>!</p>
