                    ...
                    <tr>
                        ...
                        <td class="posts_boxContent__XjPnA">
                            <div class="posts_contentPost___PyGu">
                                <div class="posts_title__P1NsS">🎉 SỰ KIỆN 8/3 - NGỌC RỒNG <?php echo GAME_NAME; ?> 🎉</div>
...
<div>
    <div class="fr-view" style="background-color: rgb(255, 255, 255);">
        <p><strong>💖 CHÀO MỪNG NGÀY QUỐC TẾ PHỤ NỮ 8/3 💖</strong></p>
        
        <hr>

        <p><strong>🔥 X3 NẠP THẺ & NHẬN ĐIỂM SỰ KIỆN</strong></p>
        <ul>
            <li>⏳ <strong>Thời gian:</strong> 09/03/2025 - 12/03/2025.</li>
            <li>💰 Khi nạp từ <strong>20.000 VNĐ</strong> trở lên sẽ được x3 số tiền nạp.</li>
            <li>🎁 Nhận <strong>Điểm Sự Kiện 8/3</strong> với tỉ lệ: <strong>100 VNĐ = 1 điểm sự kiện</strong>.</li>
        </ul>

        <hr>

        <p><strong>⚡ X6 TNSM TOÀN SERVER</strong></p>
        <ul>
            <li>⏳ <strong>Thời gian:</strong> 09/03/2025 - 12/03/2025.</li>
            <li>🚀 Toàn bộ server được <strong>x6 TN Sức Mạnh</strong>.</li>
        </ul>

        <hr>

        <p><strong>🌹 THU THẬP & ĐỔI QUÀ SỰ KIỆN</strong></p>
        <ul>
            <li>🏞️ <strong>Bông Hoa Hồng</strong> có thể kiếm được bằng cách <strong>train quái</strong> ở tất cả các map, <strong>trừ các map gần làng</strong>.</li>
            <li>🌸 Hoa hồng cũng mọc dại tại các <strong>map quanh làng, vách núi, đảo</strong>. Hãy tìm và hái chúng!</li>
            <li>🎁 Khi thu thập đủ <strong>Hoa Hồng</strong>, đến gặp <strong>Bulma Bunny</strong> để <strong>tỉa hoa & tặng hoa</strong>.</li>
            <li>🎲 Có cơ hội nhận các <strong>vật phẩm sự kiện hiếm</strong>!</li>
        </ul>

        <hr>

        <p><strong>🛍️ SHOP SỰ KIỆN BULMA BUNNY</strong></p>
        <p>Bán các vật phẩm quan trọng trong sự kiện:</p>
        <ul>
            <li>🌱 <strong>Túi Hạt Giống</strong></li>
            <li>🪴 <strong>Chậu Đất</strong></li>
            <li>💧 <strong>Thuốc Tăng Trưởng</strong></li>
            <li>🎀 <strong>Nơ Trang Trí</strong></li>
        </ul>

        <hr>

        <p><strong>🌱 TRỒNG HOA HỒNG GIẤY</strong></p>
        <ul>
            <li>🌾 Cần thu thập <strong>Đất Trồng</strong> tại các map có <code>mapId == 4 || 20 || 27 || 28 || 31 || 32 || 35 || 36 || 37</code>.</li>
            <li>💦 <strong>Ống Tre Nước</strong>: Săn Boss Ăn Trộm.</li>
            <li>🛒 <strong>Túi Hạt Giống, Chậu Đất, Thuốc Tăng Trưởng</strong>: Mua tại <strong>Shop Bulma Bunny</strong>.</li>
            <li>📌 Khi có đủ nguyên liệu, có thể <strong>trồng ra Hoa Hồng Giấy</strong>.</li>
        </ul>

        <hr>

        <p><strong>🎁 CHẾ TẠO GÓI HỘP QUÀ</strong></p>
        <ul>
            <li>🎁 <strong>2 loại hộp quà:</strong></li>
            <ul>
                <li>📦 <strong>Hộp Quà Nhẹ Nhàng</strong>: Nhận <strong>vật phẩm sự kiện + 10 điểm sự kiện</strong>.</li>
                <li>🎁 <strong>Hộp Quà Chỉnh Chu</strong>: Nhận <strong>Cải Trang Sự Kiện + 20 điểm sự kiện</strong>.</li>
            </ul>
            <li>🔹 <strong>Nguyên liệu chế tạo:</strong></li>
            <ul>
                <li>🌸 <strong>Hoa Hồng Giấy</strong>.</li>
                <li>🍫 <strong>Sôcôla Trái Tim</strong>: Tìm bằng cách <strong>tặng hoa</strong> cho Bulma Bunny.</li>
                <li>📦 <strong>Hộp Đựng Quà</strong>: Thu thập <strong>Giấy Màu</strong> tại các map có <code>mapId == 29 || 33 || 38 || 30 || 34</code>.</li>
                <li>🎀 <strong>Nơ Trang Trí</strong>: Mua tại <strong>Shop Bulma Bunny</strong>.</li>
            </ul>
            <li>📌 Khi thu thập đủ, có thể <strong>gấp giấy lại thành hộp đựng quà</strong> và chế tạo!</li>
        </ul>

        <hr>

        <p><strong>🏆 ĐUA TOP TÍCH ĐIỂM SỰ KIỆN</strong></p>
        <ul>
            <li>🎯 <strong>Điểm Sự Kiện</strong> có thể đổi tại <strong>Shop Bunma Rider</strong>.</li>
            <li>🏅 Điểm tích lũy sẽ được <strong>lưu lại để đua top</strong>.</li>
            <li>🎊 Người chơi top đầu sẽ nhận được <strong>phần quà giá trị</strong>.</li>
        </ul>
