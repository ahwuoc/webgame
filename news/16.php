...
<div>
    <div class="fr-view" style="background-color: rgb(255, 255, 255);">
        ...
        <p><strong>🏖️ CHUỖI HOẠT ĐỘNG HÈ SÔI ĐỘNG</strong></p>
        <p>Mùa hè đã đến! Hãy cùng khám phá các hoạt động cực kỳ thú vị và nhận những phần quà độc quyền trong sự kiện hè năm nay nhé!</p>

        <hr>

        <p><strong>🪲 1. BẮT CÔN TRÙNG – TRUY LÙNG BỌ HIẾM</strong></p>
        <ul>
            <li>🔸 Yêu cầu: Vợt bắt côn trùng (mua tại NPC Mị Nương)</li>
            <li>🔸 Di chuyển đến map <strong>Rừng Rậm</strong>, sử dụng vợt để bắt côn trùng</li>
            <li>🔸 Thu thập đủ số lượng có thể <strong>ghép Pet ngẫu nhiên</strong> tại <strong>NPC Poc – Bãi Biển</strong> (cần thêm Mật Ong)</li>
        </ul>

        <hr>

        <p><strong>🎣 2. CÂU CÁ – THƯ GIÃN NHẬN QUÀ</strong></p>
        <ul>
            <li>🔸 Yêu cầu: Cần câu + Giun (mua tại Mị Nương)</li>
            <li>🔸 Đến map <strong>NamKame</strong> để câu cá</li>
            <li>🔸 Cơ hội câu được <strong>cá hiếm</strong>, dùng đổi phần thưởng tại <strong>Mị Nương</strong></li>
        </ul>

        <hr>

        <p><strong>🐚 3. UP VẬT PHẨM BIỂN – GOD VALLEY</strong></p>
        <ul>
            <li>🔸 Tham gia map <strong>God Valley</strong> để thu thập:</li>
            <ul>
                <li>🐚 Vỏ Sò</li>
                <li>🦀 Con Cua</li>
                <li>⭐ Sao Biển</li>
            </ul>
            <li>🔸 Đổi quà tại <strong>NPC Poc – Bãi Biển</strong> để nhận phần thưởng đặc biệt</li>
        </ul>

        <hr>

        <p><strong>🛁 4. CHẾ TẠO BỒN TẮM – TẮM MÁT NHẬN ĐIỂM</strong></p>
        <ul>
            <li>🔸 Thu thập nguyên liệu:</li>
            <ul>
                <li>🌿 Cành Khô – rơi từ Boss Ăn Trộm</li>
                <li>🔥 Que Đốt – rơi từ Boss Pic, Poc, King Kong Hè</li>
                <li>🪵 Gỗ Lớn – up tại các map Tương Lai</li>
                <li>💧 Nước Suối Tinh Khiết – up tại Đảo Kame</li>
            </ul>
            <li>🔸 Có 2 loại Bồn Tắm: <strong>Bồn Tắm Gỗ</strong> và <strong>Bồn Tắm Vàng</strong></li>
            <li>🔸 Khi dùng sẽ <strong>+ Điểm Sự Kiện</strong></li>
            <li>🔸 Dùng điểm đổi quà tại <strong>NPC Quy Lão</strong></li>
        </ul>

        <hr>

        <p><strong>🦋 5. GHÉP BỌ – PET CÔN TRÙNG NGẪU NHIÊN</strong></p>
        <ul>
            <li>🔸 Khi đã thu thập đủ côn trùng yêu cầu</li>
            <li>🔸 Dùng Mật Ong + Côn trùng để ghép thành <strong>Pet ngẫu nhiên</strong> tại <strong>NPC Poc – Bãi Biển</strong></li>
            <li>🔸 Pet có ngoại hình và kỹ năng độc đáo, chỉ xuất hiện trong sự kiện hè!</li>
        </ul>

        <hr>

        <p><strong>🛍️ 6. NPC MỊ NƯƠNG – SHOP SỰ KIỆN</strong></p>
        <ul>
            <li>🛒 Bán các vật phẩm thiết yếu cho sự kiện như: Vợt, Cần Câu, Giun, Mật Ong, Khung Pet...</li>
            <li>🎁 Đồng thời là nơi <strong>đổi thưởng cá hiếm</strong> từ hoạt động câu cá</li>
        </ul>

        <hr>

        <p><strong>🎁 PHẦN THƯỞNG ĐẶC BIỆT</strong></p>
        <ul>
            <li>👕 Cải Trang Hè độc quyền</li>
            <li>🧸 Pet côn trùng dễ thương</li>
            <li>🏄‍♂️ Ván Lướt Sóng, Bồn Tắm tăng chỉ số</li>
            <li>🎁 Nhiều vật phẩm hiếm và trang bị sự kiện</li>
        </ul>
        ...
        <ul>
            <li>⏳ Các vật phẩm sự kiện sẽ bị thu hồi sau 30 ngày kể từ ngày kết thúc</li>
