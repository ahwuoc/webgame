                    ...
                    <tr>
                        ...
                        <td class="posts_boxContent__XjPnA">
                            <div class="posts_contentPost___PyGu">
                                <div class="posts_title__P1NsS">🔥 TÍNH NĂNG MỚI: ĐỆ TỬ CAĐIC – CHIẾN BINH TRUYỀN THUYẾT 🔥</div>
<div class="posts_boxTime__bFU28"><span class="posts_time__PFYQE"><i>Thời gian: Sau bảo trì ngày 30/05/2025</i></span></div>
<div>
    <div class="fr-view" style="background-color: rgb(255, 255, 255);">
        <p><strong>🌀 GIỚI THIỆU ĐỆ TỬ MỚI – CAĐIC</strong></p>
        <ul>
            <li>✅ Hình dáng tiến hóa theo từng cấp độ</li>
            <li>✅ Sức mạnh vượt trội, tiềm năng chiến đấu bùng nổ</li>
            <li>✅ Đồng hành cùng bạn trên hành trình chinh phục vũ trụ</li>
        </ul>

        <hr>

        <p><strong>🎯 ĐIỀU KIỆN ĐỂ ĐỔI ĐỆ TỬ CAĐIC</strong></p>
        <ul>
            <li>🔸 Đã sở hữu đệ tử Ma Bư hoặc Trứng Bư đã nở</li>
            <li>🔸 Đệ tử hiện tại đạt ít nhất 40 tỷ sức mạnh</li>
            <li>🔸 Có vật phẩm đặc biệt: <strong>Bình Hút Năng Lượng Bư</strong></li>
        </ul>

        <hr>

        <p><strong>🎁 CÁCH NHẬN BÌNH HÚT NĂNG LƯỢNG BƯ</strong></p>
        <ul>
            <li>🔥 Rơi ngẫu nhiên khi tiêu diệt Boss Hirudegarn</li>
            <li>⚠️ Chỉ người có đệ Ma Bư/Trứng Bư nở và đạt 40 tỷ sức mạnh mới nhận được</li>
        </ul>

        <hr>

        <p><strong>🧭 HƯỚNG DẪN ĐỔI ĐỆ TỬ CAĐIC</strong></p>
        <ol>
            <li>Đi đến map <strong>Đại Hội Võ Thuật</strong></li>
            <li>Gặp <strong>NPC Kibit</strong> để vào bản đồ hút năng lượng</li>
            <li>Tiến hành hút đủ <strong>2000 Kilis</strong></li>
            <li>Sau đó dùng đệ hiện tại để đổi sang <strong>Đệ Cađic</strong></li>
        </ol>

        <hr>

        <p><strong>⚡ NÂNG CẤP ĐỆ TỬ CAĐIC</strong></p>
        <ul>
            <li>🔓 Mở khóa tối đa <strong>1 kỹ năng mới</strong> dành riêng cho Cađic</li>
            <li>🎒 Mở rộng thêm <strong>2 ô trang bị mới</strong> hỗ trợ kỹ năng đặc biệt</li>
            <li>📈 Có <strong>9 cấp độ nâng cấp</strong>:</li>
            <ul>
                <li>🔹 Mỗi cấp tăng thêm % chỉ số sức mạnh và phòng thủ</li>
                <li>🎨 Ngoại hình thay đổi rõ rệt theo từng cấp độ</li>
            </ul>
        </ul>

        <hr>

        <p><strong>🎁 PHẦN THƯỞNG – SỨC MẠNH MỚI</strong></p>
        <ul>
            <li>💪 Cađic sở hữu kỹ năng riêng và hiệu ứng chiến đấu đặc biệt</li>
            <li>👊 Có thể học kỹ năng mới và nâng cấp như đệ tử thông thường</li>
            <li>🔥 Hiệu ứng kỹ năng rực rỡ, đặc biệt từ cấp độ 7 trở lên</li>
        </ul>
        ...
        <ul>
            <li>🔄 Khi đổi sang Cađic, đệ tử cũ sẽ bị thay thế</li>
